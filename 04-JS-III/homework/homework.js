...
function multiplicarArgumentos() {
  // Usá la palabra clave `arguments` para multiplicar todos los argumentos y devolver el producto
...
function todosIguales(arreglo) {
  ...
  {
    if (arreglo[0] !== arreglo[i + 1]) return false;
  }
